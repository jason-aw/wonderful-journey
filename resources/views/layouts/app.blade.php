            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('users/'.Auth::user()->id.'/edit') }}">Profile</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('articles') }}">Admin</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('register') }}"><i class="fas fa-user"></i> Register</a>
                            </li>
